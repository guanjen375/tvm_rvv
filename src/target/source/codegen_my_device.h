...
/*!
 * \file codegen_my_device.h
 * \brief Generate My_device code.
 */
#ifndef TVM_TARGET_SOURCE_CODEGEN_MY_DEVICE_H_
#define TVM_TARGET_SOURCE_CODEGEN_MY_DEVICE_H_
...
namespace tvm
{
  namespace codegen
  {
    ...
    class CodeGenmy_device : public CodeGenC
    {
    public:
      CodeGenmy_device();
...
#endif // TVM_TARGET_SOURCE_CODEGEN_MY_DEVICE_H_
